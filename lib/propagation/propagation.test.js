...
cases("marshaling aws", opts => expect(aws.marshalTraceContext(testContext)).toEqual(opts.header), [
  {
    name: "honeycomb headers get version prefix, propagate span as Parent",
    textContext: {
      id: "abcdef123456",
      dataset: "testDataset",
      stack: [new Span({ [schema.TRACE_SPAN_ID]: "0102030405" })],
    ...
    header:
      "Root=1-abcdef123456;Parent=1-0102030405;userID=1;errorMsg=failed to sign on;toRetry=true",
  },
  {
    name: "ids propagated from aws, prefix as expected without doubling, propagate span as Parent",
    textContext: {
      id: "1-abcdef123456",
      dataset: "testDataset",
      stack: [new Span({ [schema.TRACE_SPAN_ID]: "0102030405" })],
  ...
  [
    {
      ...
      contextStr:
        "Root=1-abcdef123456;Self=0102030405;userID=1;errorMsg=failed to sign on;toRetry=true",
      value: {
    ...
    },
    {
      ...
      contextStr: "Root=1-abcdef123456;Self=0102030405",
      value: {
        traceId: "1-abcdef123456",
        parentSpanId: "0102030405",
      },
