...
const { honeycomb, otel, aws } = propagation;
...
module.exports = {
  ...
  AMAZON_TRACE_HTTP_HEADER: aws.AMAZON_TRACE_HTTP_HEADER,
  REQUEST_ID_HTTP_HEADER: honeycomb.REQUEST_ID_HTTP_HEADER,
  OTEL_HTTP_HEADER: otel.TRACE_PARENT_HEADER,
  marshalTraceContext: honeycomb.marshalTraceContext,
  unmarshalTraceContext: honeycomb.unmarshalTraceContext,

  unmarshalAWSTraceContext: aws.parseAWSTraceHeader,
