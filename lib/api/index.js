...
const headers = propagation.honeycomb;
...
module.exports = {
  ...
  TRACE_HTTP_HEADER: headers.TRACE_HTTP_HEADER,
  AMAZON_TRACE_HTTP_HEADER: headers.AMAZON_TRACE_HTTP_HEADER,
  REQUEST_ID_HTTP_HEADER: headers.REQUEST_ID_HTTP_HEADER,
  OTEL_HTTP_HEADER: headers.OTEL_HTTP_HEADER,
  marshalTraceContext: headers.marshalTraceContext,
  unmarshalTraceContext: headers.unmarshalTraceContext,
