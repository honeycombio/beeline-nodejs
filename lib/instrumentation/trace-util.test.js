...
describe("getTraceContext", () => {
  cases(
    ...
    [
      ...
      {
        name: "root / self / parent",
        headerVal:
          "Root=1-5759e988-bd862e3fe1be46a994272793;Self=53995c3f42cd8ad8;Parent=abcdef0123456789",
        expectedContext: {
          traceId: "1-5759e988-bd862e3fe1be46a994272793",
          parentSpanId: "abcdef0123456789",
          source: "X-Amzn-Trace-Id http header",
          customContext: {
            Self: "53995c3f42cd8ad8",
          },
        },
      },
      {
      ...
      },
      {
        ...
        name: "no root / self",
        headerVal: "Self=53995c3f42cd8ad8",
        expectedContext: {},
      },
    ]
  );
