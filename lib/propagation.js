...
const { TRACE_PARENT_HEADER } = "@opentelemetry/core";
...
function marshalTraceContextv1(context) {
  console.log("marshal trace context v1");
...
function unmarshalTraceContext(contextStr) {
  console.log("unmarshal trace context");
...
function unmarshalTraceContextv1(payload) {
  console.log("unmarshall trace context v1");
